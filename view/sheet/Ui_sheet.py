...
class Ui_Sheet(object):
    def setupUi(self, MainWindow):
        ...
        # test window
        MainWindow.setObjectName("Sheet Demo")
        ...
        def setKey(keyType, keyNum, place):
            ...
            self.keyDict[keyName] = QtWidgets.QPushButton(self.sheetWidget)
            sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum,
                                               QtWidgets.QSizePolicy.Minimum)
            sizePolicy.setHorizontalStretch(0)
            sizePolicy.setVerticalStretch(0)
        ...
        def setNote(row, col):
            ...
            self.noteDict[noteName] = QtWidgets.QPushButton(self.sheetWidget)
            sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum,
                                               QtWidgets.QSizePolicy.Minimum)
            sizePolicy.setHorizontalStretch(0)
            sizePolicy.setVerticalStretch(0)
        ...
        def setMeasure(num):
            ...
            self.measureDict[measureName] = QtWidgets.QLabel(self.sheetWidget)
            sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum,
                                               QtWidgets.QSizePolicy.Minimum)
            sizePolicy.setHorizontalStretch(0)
            sizePolicy.setVerticalStretch(0)
        ...
        # [menuBar] File: New, Import, Export
